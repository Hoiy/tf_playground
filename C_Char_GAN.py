...
def create_baseline():
    ...
    x = Dropout(0.2)(x)
    x = Dense(EMBEDDING_SIZE * SEQ_LENGTH // 2, activation='selu')(x)
    x = Dropout(0.2)(x)
    x = Dense(EMBEDDING_SIZE * SEQ_LENGTH // 4, activation='selu')(x)
    x = Dropout(0.2)(x)
    x = Dense(EMBEDDING_SIZE * SEQ_LENGTH // 8, activation='selu')(x)
    x = Dropout(0.2)(x)
